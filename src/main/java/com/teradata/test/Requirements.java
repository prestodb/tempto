...
public final class Requirements {
    ...
    private static class SingletonCompositeRequirement implements CompositeRequirement {
    ...
    private static class MultiCompositeRequirement implements CompositeRequirement {
